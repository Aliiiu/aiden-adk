...
**Note:** `DATABASE_URL` is a required environment variable. The application
will not start without it. For testing the agent without database persistence,
use the web interface (`adk web`).
